      ...
      <Field>
                    ...
                    <div style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginTop: 12, alignItems: "center" }}>
                          ...
                          {canApply && jobOpen ? (
                            <Button size="sm" disabled={busy || batchBusy} onClick={() => void applyCandidate(id)}>
        ...
        {canApply && jobOpen && items.length > 0 ? (
          <div style={{ marginTop: 12, display: "flex", flexWrap: "wrap", gap: 8, alignItems: "center" }}>
            <Button size="sm" disabled={batchBusy || selected.size === 0} onClick={() => void shortlistSelected()}>
              {batchBusy ? "Shortlisting…" : selected.size === 0 ? "Shortlist selected" : `Shortlist selected (${selected.size})`}
            </Button>
            <Button size="sm" variant="ghost" disabled={loading || batchBusy} onClick={() => void load()}>
              Refresh
            </Button>
          </div>
        ) : (
