import { BULLET_POINTS } from "@/src/lib/open-resume/parse-resume-from-pdf/extract-resume-from-sections/lib/bullet-points";
import { isBold } from "@/src/lib/open-resume/parse-resume-from-pdf/extract-resume-from-sections/lib/common-features";
import type { Lines, Line, Subsections } from "@/src/lib/open-resume/parse-resume-from-pdf/types";
